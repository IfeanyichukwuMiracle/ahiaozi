  ...
  return (
    <>
      <div className="bg-[#fefefe] shadow-md rounded-sm absolute -bottom-[10.1rem] right-4 w-max">
        <p className="px-3 py-2 cursor-pointer">Profile</p>
        <p className="px-3 py-2 cursor-pointer border-gray-100 border-t">
          Switch to Customer
        </p>
        <p className="px-3 py-2 cursor-pointer border-t border-gray-100 border-b">
          Switch to Affiliate
        </p>
        <p className="text-red-500 px-3 py-2 cursor-pointer">Logout</p>
      </div>
    </>
  );
}
